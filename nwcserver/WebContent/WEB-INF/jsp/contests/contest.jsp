...
<link href="${resources}css/contests/contests-style.css"
	rel="stylesheet" />

<script type="text/javascript"
	src="${resources}js/bootstrap/bootstrap-dialog.js"></script>
<script type="text/javascript"
							...
							<div class="panel-body">
								...
								<div class="edit text-center drop-block-element"
									...
									<security:authorize access="!isAuthenticated()">
										<h4>
											<label class="label label-info label"> <spring:message
													code="contest.unauthenticated" />
											</label>
										</h4>
									</security:authorize>
								</div>
